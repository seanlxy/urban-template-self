...
function do_main(){
    ...
    function generate_item_list($parent_id = 0)
    {
        ...
        DATE_FORMAT(pmd.`date_created`, '%d %M %Y %h:%i %p') AS created_date, DATE_FORMAT(pmd.`date_updated`, '%d %M %Y %h:%i %p') AS updated_date
        ...
        if( !empty($rows) )
        {
            ...
            foreach ($rows as $index => $row)
            {
                ...
                <tr>
                    ...
                    <td width="250" align="right">$created_date</td>
                    <td width="250" align="right">$updated_date</td>
