    ...
    $.fn.checkbox=function(f){
        ...
        var h=function(a){
            ...
            a.stateInterval=setInterval(function(){
                ...
                if(a.checked!=b){
                    this_name = d.attr('name');
                    ind = this_name.lastIndexOf('_')+1;
                    this_id = this_name.substring(ind);
                    d.trigger((b=!!a.checked)?'check':'uncheck');
                    if(b=!!a.checked){
                            $('input[name=cmsset_value_'+this_id+']').removeClass('disabledinput');
                        }else{
                           $('input[name=cmsset_value_'+this_id+']').addClass('disabledinput');
                        }
                }
            },10);
            return d
